...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, "Television", "Samsung", 4000.00, 25, c1);
		Product p2 = new Product(null, "CD Player", "Sony", 299.90, 13, c1);
		Product p3 = new Product(null, "Shoes Red and Black", "Nike",359.90, 8, c2);
		Product p4 = new Product(null, "Batman Action Figure", "Hasbro", 199.00, 12, c3);
		Product p5 = new Product(null, "Iphone X", "Apple", 2700.00, 19, c1);
